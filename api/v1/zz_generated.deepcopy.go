...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SiteSpecGit) DeepCopyInto(out *SiteSpecGit) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SiteSpecGit.
func (in *SiteSpecGit) DeepCopy() *SiteSpecGit {
	if in == nil {
		return nil
	}
	out := new(SiteSpecGit)
