...
import (
	...
	"github.com/dtrouillet/site-operator/controllers"
...
func main() {
	...
	flag.StringVar(&probeAddr, "health-"+
		"probe-bind-address", ":8081", "The address the probe endpoint binds to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7680ad33.faya.fr",
	})
	if err != nil {
